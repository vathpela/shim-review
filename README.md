...
*******************************************************************************
Business policy says we have to have a shim built from RHEL 10 tooling.
...
*******************************************************************************
The current builds include the grub,4 and grub,5 fixes
...
*******************************************************************************
vendor_cert contains redhatsecurebootca8.cer, which is included in this
repository.
...
*******************************************************************************
This is for aarch64, and we now also have a UKI built with systemd-stub that
has a kernel built-in and launched directly.
...
grub.rh,2,Red Hat,grub2,2.12-28.el10,mailto:secalert@redhat.com
grub.centos,2,Red Hat,grub2,2.12-28.el10,mailto:secalert@redhat.com
...
kernel-uki-virt:
sbat,1,SBAT Version,sbat,1,https://github.com/rhboot/shim/blob/main/SBAT.md
linux,1,Red Hat,linux,6.12.0-55.31.1.el10_0.aarch64,mailto:secalert@redhat.com
linux.rhel,1,Red Hat,linux,6.12.0-55.31.1.el10_0.aarch64,mailto:secalert@redhat.com
kernel-uki-virt.rhel,1,Red Hat,kernel-uki-virt,6.12.0-55.31.1.el10_0.aarch64,mailto:secalert@redhat.com
systemd-stub,1,The systemd Developers,systemd,257,https://systemd.io/
systemd-stub.rhel,1,Red Hat Enterprise Linux,systemd,257-9.el10_0.1-gb51bb0d,mailto:secalert@redhat.com
...
video xfs zstd efi_netfs efifwsetup efinet lsefi lsefimmap connectefi
...
*******************************************************************************
Currently it's kernel-6.12.0-55.31.1.el10_0.  It has all the patches we've previously discussed.
