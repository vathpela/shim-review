...
-------------------------------------------------------------------------------
Source rpm is:
https://pjones.fedorapeople.org/rhel-7-shim-20210521/shim-15.4-4.el7.src.rpm
Repos for build deps etc are:
Docker container centos:centos7.2.1511 + https://pjones.fedorapeople.org/rhel-7-shim-20210521/repo

-------------------------------------------------------------------------------
What patches are being applied and why:
-------------------------------------------------------------------------------
We have a couple of patches:
- 2 build issues - 0001-GAAAAAAAAH.patch
  - we don't have binutils-2.24 with `objcopy -D` in the build root I needed to
    use, but it doesn't actually matter, because pr 375 also accomplishes what
    `objcopy -D` is supposed to do.
  - dos2unix in this buildroot doesn't support -r, which we don't actually need.
- upstream 822d07ad4f - 0002-Fix-handling-of-ignore_db-and-user_insecure_mode.patch
- upstream a0f701501f - 0003-shim-15.4-branch-update-.gitmodules-to-point-at-shim.patch
- upstream 5b3ca0d2f7 - 0004-Fix-a-broken-file-header-on-ia32.patch
- upstream 4068fd42c8 - 0005-mok-allocate-MOK-config-table-as-BootServicesData.patch
- upstream 493bd940e5 - 0006-Don-t-call-QueryVariableInfo-on-EFI-1.10-machines.patch
- upstream 05875f3aed - 0007-Post-process-our-PE-to-be-sure.patch
