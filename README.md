...
*******************************************************************************
RHEL 8 has a different set of trusted certificates than later versions.
...
*******************************************************************************
All of the appropriate commits are present and the configuration setting
CONFIG_EFI_CUSTOM_SSDT_OVERLAYS is disabled.
...
*******************************************************************************
This is built on a RHEL 8.  The Dockerfile in this repository can be used to
launch an identical buildroot.  (Tested using podman, so that's probably a
...
grub.rh,2,Red Hat,grub2,2.02-154.el8,mailto:secalert@redhat.com
...
(yes, I see that we've managed to use three different ways to say
secalart@redhat.com.  I have chosen to not be bothered by it.)
...
*******************************************************************************
Currently it's kernel-4.18.0-539.el8.  It has all the patches we've previously discussed.
