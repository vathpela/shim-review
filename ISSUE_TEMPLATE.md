...
Here is the review repo: [vathpela/shim-review@rhel-7-shim-20210521](https://github.com/vathpela/shim-review/tree/rhel-7-shim-20210521), which includes `README.md`, both shim EFI binaries, `redhatsecurebootca5.cer`, and the build logs `root.log` and `build.log`.
...
shim.redhat,1,Red Hat,shim,15.4-4.el7,secalert@redhat.com
```
...
grub.rhel7,1,Red Hat Enterprise Linux 7,grub2,1:2.02-0.87.el7_9.7,mail:secalert@redhat.com
```
