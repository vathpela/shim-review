...
RUN wget -O shim-rhel-9-x64-20250818.efi https://github.com/vathpela/shim-review/raw/refs/heads/rhel-9-x64-20250818/shimx64.efi
RUN ./post-process-pe -n -x shimx64.efi
RUN hexdump -Cv shim-rhel-9-x64-20250818.efi > shim-rhel-9-x64-20250818.hex
...
RUN diff -u shim-rhel-9-x64-20250818.hex new.hex || :
